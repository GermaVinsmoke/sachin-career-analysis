...
const Container = styled.div`
  background-image: linear-gradient(rgba(0, 0, 0, .5), rgba(0, 0, 0, 0.5)), url(${bgImg});
  height: 100vh;
    ...
    return (
      <Container>
        <div>
          ...
          <InfoContent>
            <Heading3 left='10px' fontWeight='300'>Matches</Heading3>
            <Heading3 right='10px'>{info.match_count}</Heading3>
          </InfoContent>
          <InfoContent>
            <Heading3 left='10px' fontWeight='300'>Runs</Heading3>
            <Heading3 right='10px'>{info.total_runs}</Heading3>
          </InfoContent>
          <InfoContent>
            <Heading3 left='10px' fontWeight='300'>50s</Heading3>
            <Heading3 right='10px'>{info.half_century_count}</Heading3>
          </InfoContent>
          <InfoContent>
            <Heading3 left='10px' fontWeight='300'>100s</Heading3>
            <Heading3 right='10px'>{info.century_count}</Heading3>
          </InfoContent>
          <InfoContent>
            <Heading3 left='10px' fontWeight='300'>Highest Score</Heading3>
